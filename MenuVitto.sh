...
echo
echo
echo -e "\033[1;37m()----> \033[1;31mOpcion (2): Informacion de un BIN, esta opcion te dice el pais, la red del BIN, tipo de tarjeta "
echo -e "la marca, el nombre del banco, latitud y longitu"
echo
echo
echo -e "\033[1;37m()----> \033[1;31mOpcion (3): Extrapolacion, no se que hace xd"
echo
echo
